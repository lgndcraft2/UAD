          ...
          <p className="text-gray-600">No inquiries found.</p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-4 sm:pb-6">
                ...
                <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
                    <h2 className="text-base font-bold text-gray-900">Inquiries</h2>
                </div>
                    ...
                    <li key={inquiry.id} className="border-b border-gray-200 last:border-b-0">
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 gap-3 sm:gap-0">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                                ...
                                <span className={`px-3 py-1 rounded-full text-xs font-semibold border inline-flex self-start ${
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-sm text-gray-600">
                                ...
                                <span className="truncate">Session: {inquiry.advisory_session}</span>
                                </div>
                                <div className="flex items-center space-x-1">
                            ...
                            <span className={`px-3 py-1 rounded-full text-xs font-semibold border inline-flex ${
                                inquiry.status === 'Open' 
                                ? 'bg-green-100 text-green-700 border-green-300' 
